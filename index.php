...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header id="home" class="header">
        <div class="overlay text-white text-center">
            ...
            <a id="plantilla" href="plantilla.php">PLANTILLA <i class="fas fa-file-alt"></i></a>
            <h2 style="font-size:30px; top:150px; position:relative; text-shadow: black 5px 5px 5px;">Oportunidad de dar un salto internacional a Arabia</h2>
            <a id="sabermas" style="font-size: 25px; top: 150px; position: relative; color: white; border: 2px solid white; border-radius: 5px; padding: 3px; text-shadow: black 5px 5px 5px;" href="arabia.php">Saber más <i class="fas fa-plus"></i></a>
        </div>
    </header>
    ...
    <div id="contact" class="container-fluid bg-dark text-light border-top wow fadeIn">
        <div class="row">
            <div class="col-md-6 px-5 has-height-lg middle-items">
                ...
                <p>Nuestro campo de fútbol está ubicado en el corazón de Reus, en el Camp de futbol Les Borges.<br>Ven y disfruta de nuestros partidos en un ambiente familiar y apasionado.</p>
                <br>
                <div class="text-muted">
                    <p><span class="ti-location-pin pr-3"></span> Campo de fútbol Les Borges, Plaça Ua 1, Ua 3-10, Ua 12,UA18, 94, 43350 Les Borges del Camp, Tarragona</p>
